...
export class WebApp {
     ...
     */
    async #customFetch(method, url, data, returnType) {  //---------->to: index.js line 354
        ...
        let response = await request[returnType](); //return type is JSON string  ----------> to: index.js line 354
        return response;
    }
