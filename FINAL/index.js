...
app.events.click("changeListName", async () => {
    ...
    // Go back from the DB
    const listNewData = await app.PUT("api/test.php", listFormDataJSObj); // ---------------> PUT from: test.php line123; (send JSON to JS) 
                                                                          // app from app.js line 35

    console.log(listNewData);  //------------>  from app.js line 51; confirm that it is a JSON string in console ?s
